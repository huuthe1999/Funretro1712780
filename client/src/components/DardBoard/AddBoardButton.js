        ...
        <>
            <Grid item xs={12} sm={6} md={3} >
                <Card className={classes.card} onClick={handleShowModal}>
                    ...
                    <Typography className={classes.cardTitle}>Add board</Typography>
                </Card>
            </Grid>
            {displayBoardModal ? <AddBoardModal handleToggleModal={handleHiddenModal} onAddBoard={onAddBoard} /> : null}
