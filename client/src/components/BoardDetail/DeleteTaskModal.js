...
export default function DeleteTaskModal({ handleToggleModal, handleDeleteTask }) {
                ...
                <DialogContent dividers>
                    <form className={classes.form} noValidate onSubmit={handleSubmit}>
                        <div className={classes.root}>
                            ...
                            <div className={classes.warningText}><Typography variant="h5" align='center'>Bạn có muốn xóa Task này không ?</Typography></div>
                        </div>
