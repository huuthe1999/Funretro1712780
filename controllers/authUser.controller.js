...
//sgMail.setApiKey('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');
sgMail.setApiKey("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");
...
exports.registerController = (req, res) => {
    ...
    if (!errors.isEmpty()) {
        ...
        const token = jwt.sign({
            ...
            name,
            password,
        }, process.env.JWT_USER_ACTIVE, { expiresIn: '15m' });
